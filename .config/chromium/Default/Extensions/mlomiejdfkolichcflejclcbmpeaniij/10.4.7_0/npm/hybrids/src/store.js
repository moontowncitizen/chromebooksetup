import { getEntry, get as get$1, invalidate, getEntries, invalidateAll, set as set$1, assert, getCurrentValue } from './cache.js';
...
function syncCache(config, id, model, invalidate = true) {
  set$1(config, id, invalidate ? resolveWithInvalidate : resolve, model);
  return model;
}
          ...
          return (model, data, lastModel) => {
            ...
            for (const id of Object.keys(record)) {
              ...
              Object.defineProperty(result, id, {
                get() {
                  return get$1(this, id, () => item.value);
                },
                enumerable: true,
              });
            }
...
export { configs, store$1 as default, lists };
