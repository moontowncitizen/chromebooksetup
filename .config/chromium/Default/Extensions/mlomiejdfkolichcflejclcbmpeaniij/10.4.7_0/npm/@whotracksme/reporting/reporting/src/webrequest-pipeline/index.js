import WebRequestListenersManager, { VALID_RESPONSE_PROPERTIES } from './utils/webrequest.js';
import Pipeline from './pipeline.js';
import WebRequestContext from './webrequest-context.js';
import PageStore from './page-store.js';
import logger from './logger.js';
import CnameUnloak, { isCnameUncloakSupported } from './cname-uncloak.js';
...
class WebRequestPipeline {
  ...
  init(_settings, browser) {
    ...
    this.cnameUncloaker = isCnameUncloakSupported(browser)
      ? new CnameUnloak(browser.dns.resolve)
      : null;
...
export { WebRequestPipeline as default };
