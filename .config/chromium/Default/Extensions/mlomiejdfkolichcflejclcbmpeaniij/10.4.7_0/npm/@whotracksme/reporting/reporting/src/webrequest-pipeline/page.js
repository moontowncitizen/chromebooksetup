...
function create({ id, active, url, incognito, created }) {
  const page = {};
  page.id = id || 0;
  page.url = url;
...
function setActive(page, active) {
...
function getStatsForDomain(page, domain) {
...
function getFrameAncestors(page, { parentFrameId }) {
  const ancestors = [];
 ...
 */
function getFrameUrl(page, context) {
...
export { PAGE_LOADING_STATE, create, getFrameAncestors, getFrameUrl, getStatsForDomain, setActive };
