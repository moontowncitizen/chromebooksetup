import { sortCategories } from '../npm/@ghostery/ui/src/utils/categories.js';
...
const setup = asyncSetup([init(TRACKERDB_ENGINE)]);
...
export { getCategories, getMetadata, getSimilarTrackers, getTracker, getUnidentifiedTracker, setup };
