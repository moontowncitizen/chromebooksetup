...
const FREQUENCY_TYPES = ['all', ...Object.keys(FREQUENCIES)];
const CRITICAL_METRICS = ['install', 'active', 'engaged', 'uninstall'];
...
export { CRITICAL_METRICS, FREQUENCY_TYPES, buildQueryPair, Metrics as default, processUrlQuery };
