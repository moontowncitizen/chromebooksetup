...
import __vite_glob_0_18 from './preview.js';
          ...
          <section layout="column gap:4">
            ...
            >
              <div layout="row items:start gap:2" layout@768px="gap:3">
                <a href="${router.url(__vite_glob_0_18, PREVIEWS['wtm_wheel'])}">
            ...
            html`
              ...
              >
                <div layout="row items:start gap:2" layout@768px="gap:3">
                  <a href="${router.url(__vite_glob_0_18, PREVIEWS['trackers_count'])}">
                    <gh-settings-help-image>
                      <img
            ...
            >
              <div layout="row gap:2" layout@768px="gap:3">
                <a href="${router.url(__vite_glob_0_18, PREVIEWS['trackers_preview'])}">
                  <gh-settings-help-image>
                    <img
