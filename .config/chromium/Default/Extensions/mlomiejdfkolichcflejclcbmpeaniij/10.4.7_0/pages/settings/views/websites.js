...
import NoWebsitesSVG from '../assets/no_websites.svg.js';
import __vite_glob_0_23 from './website-details.js';
import __vite_glob_0_24 from './websites-add.js';
...
const __vite_glob_0_25 = {
  [router.connect]: { stack: [__vite_glob_0_23, __vite_glob_0_24] },
        ...
        <section layout="column gap:4" layout@768px="gap:5">
          <div layout="row items:center gap:2">
            ...
            <ui-button size="small">
              <a href="${router.url(__vite_glob_0_24)}">Add</a>
            </ui-button>
          </div>
          ${websites.length
            ? html`
