import { categories, regions } from '../../../npm/@ghostery/ui/src/utils/labels.js';
...
import __vite_glob_0_20 from './tracker-add-exception.js';
import __vite_glob_0_23 from './website-details.js';
...
const __vite_glob_0_21 = {
  [router.connect]: { stack: () => [__vite_glob_0_20] },
              ...
              <div layout="column gap:2">
                <div layout="row gap items:center content:space-between">
                  ...
                  <ui-button size="small">
                    <a href="${router.url(__vite_glob_0_20, { tracker })}">
                      Add
                    </a>
                  </ui-button>
                </div>
